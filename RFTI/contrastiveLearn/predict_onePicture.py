...
def main():
    ...
    # model.eval()
    known_face_encodings = np.loadtxt('F:\cfy_mistake_trigger/train/北山数据_22/004\known_face_encodings.txt')
    image_1 = r'F:\cfy_mistake_trigger/train\北山数据_22\004\have_animals\DSCF0001.JPG'
    # image_1 = r'F:\cfy_mistake_trigger\txt\eachCamera\test_beishanshuju004/DSCF0523.JPG'
    # image_1 = Image.open(np.fromfile(image_1, dtype=np.uint8))
