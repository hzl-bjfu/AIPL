...
def save_checkpoint(state, is_best, filename='./models_pkl/checkpoint_np_hard_samples.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, './models_pkl/model_best_np_hard_samples.pth.tar')
