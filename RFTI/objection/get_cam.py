...
def paste_image(image, heat_map, num_pred, output_path):
    txt_file = "C:\Windows\Fonts/Bahnschrift/bahnschrift.ttf"
...
if __name__ == '__main__':
    ...
    # test_model = "./models_pkl/checkpoint_n_hard_samples.pth.tar"
    ...
    for image_name in images:
        ...
        output_path = "./data/cam_csae_new/" + str(num_index) + "_" + image_name.split('.')[0] + ".jpg"
        i = i + 1
