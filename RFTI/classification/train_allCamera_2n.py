...
def main():
    ...
    result = open('./models_pkl/result_allCamera_2n_focal_50_0.5_1000.txt', 'w')
...
def val(val_loader, net, criterion,e,epoch):
    ...
    f1 = open('./test_negative_allCamera_2n_focal_50_0.5_1000.txt', 'w')
    net.eval()
    with torch.no_grad():
...
def polt_curve(epoch,tarin_Accuracy_list,tarin_Loss_list,test_Accuracy_list,test_Loss_list):
    ...
    plt.savefig("./train_allCamera_2n.jpg")
    plt.show()
