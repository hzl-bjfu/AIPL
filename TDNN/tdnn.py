...
if __name__ =='__main__':
    model = TDNN(feat_dim=128,embedding_size=512,num_classes=13)
    tmp = torch.randn(16, 128, 251)
    out, xvectors = model(tmp)
    print('out:', out.shape)
    print('out:', out)
    print('xvector:', xvectors.shape)
    # print('xvector:', xvectors)
