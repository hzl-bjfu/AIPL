...
parser = argparse.ArgumentParser(description='PyTorch TDNN Training')

# Dataset preperation
parser.add_argument('--train_class_num', default=13, type=int, help='Classes used in training')
parser.add_argument('--test_class_num', default=14, type=int, help='Classes used in testing')
...
parser.add_argument('--es', default=30, type=int, help='epoch size')
...
def main():
    args.checkpoint = './checkpoints/tdnn_centerloss/' + args.arch
    if not os.path.isdir(args.checkpoint):
        mkdir_p(args.checkpoint)

    # folder to save figures
    args.plotfolder = './checkpoints/tdnn_centerloss/' + args.arch + '/plotter'
    ...
    pkl_path = 'E:/code/snn/Bird-Song-Classification-main/Bird-Song-Classification-main/csv_pkl/S1'
    train_path = pkl_path + "/S1train.pkl"
    val_path = pkl_path + "/S1val.pkl"
    ...
    net = TDNN(feat_dim=128, embedding_size=args.embed_dim, num_classes=args.train_class_num)
